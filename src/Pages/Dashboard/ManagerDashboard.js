            ...
            <table class="table-auto w-[90%] ml-[30px] mt-[30px]">
                ...
                <tbody>
                    <tr className="flex my-[20px]">
                        ...
                        <td className="flex-1"><p className="w-[80%]">1601 branham lane Suite 40 San J</p></td>
                        <td className="flex-1">
                            <select className="">
                                <option selected>Franchise</option>
                            </select>
                        </td>
                        <td className="flex-1"><button className="bg-[#36c0f8] h-[2.26vh] min-h-[30px] text-white rounded-full w-[8vw]">Check Status</button></td>
                        <td className="flex-1"><button className="bg-[#36f87a] h-[2.26vh] min-h-[30px] text-white rounded-full w-[10vw]">Check Message</button></td>
                    </tr>
                    ...
                    <tr className="flex my-[20px]">
                        ...
                        <td className="flex-1"><button className="bg-[#36c0f8] text-white h-[2.26vh] min-h-[30px] rounded-full w-[8vw]">Check Status</button></td>
