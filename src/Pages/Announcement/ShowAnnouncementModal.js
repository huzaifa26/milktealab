    ...
    return(
        <>
            ...
            <div className="w-[calc(100vw)]  h-[100vh] fixed !z-[120] top-[calc(0%)] left-[calc(0%)]">
                <div className="shadow-md xsm:min-w-[90%] max-h-[80vh] sm:w-[80%] w-[60%] overflow-x-hidden  flex flex-col opacity-100 relative z-50 bg-white top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-[30px]">
                    <div>
