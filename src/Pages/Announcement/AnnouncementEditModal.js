    ...
    return(
        <>
            ...
            <div className="w-[calc(100vw)]  h-[100vh] fixed z-40 top-[calc(0%)] left-[calc(0%)]">
                <div className="shadow-md xsm:w-[90%] sm:w-[80%] w-[60%] overflow-x-hidden  flex flex-col opacity-100 relative z-50 bg-white top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-[30px]">
                    ...
                    <form ref={formRef} onSubmit={announcementFormHandler} className="py-[30px] flex-1 flex flex-col gap-[18px] items-center justify-center">
                        ...
                        <div className="flex xsm:flex-col text-[clamp(14px,1vw,18px]">
                            <label className="items-start inline-block w-[120px] font-bold ">Body:</label><textarea rows={4} defaultValue={props?.singleAnnouncements?.body} required name="body" placeholder="Type announcement body" type={"text"} className="min-w-[280px] inline-block w-[17vw] text-[#a4a5a5] border-b-[2px] p-2 "></textarea>
                        </div>
